...
void WorldUVRipple_float(float WorldUV, float2 UV, float OutlineThickness, float DepthSensitivity, float NormalsSensitivity, float ColorSensitivity, float4 OutlineColor, out float4 OutDepth, out float4 OutOriginal)
{
